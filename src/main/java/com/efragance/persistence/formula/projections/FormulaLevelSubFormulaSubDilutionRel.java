...
/**
 * The Class FormulaLevelSubFormulaSubDilutionRel.
 */
public class FormulaLevelSubFormulaSubDilutionRel {
    ...
    /**
     * Instantiates a new formula level sub formula sub dilution rel.
     *
     ...
     */
    public FormulaLevelSubFormulaSubDilutionRel(final Long formulaId, final String formulaCode,
            final String formulaName, final Long subFormulaId, final Long dilutionId, final String dilutionCode,
            final String dilutionName, final Long rawMaterialId, final String rawMaterialCode,
