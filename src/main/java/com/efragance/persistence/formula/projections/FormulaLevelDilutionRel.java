...
/**
 * The Class FormulaLevelDilutionRel.
 */
public class FormulaLevelDilutionRel {
    ...
    /**
     * Instantiates a new formula level dilution rel.
     *
     ...
     */
    public FormulaLevelDilutionRel(final Long formulaId, final String formulaCode, final String formulaName,
            final Long dilutionId, final String dilutionCode, final String dilutionName, final Long rawMaterialId,
            final String rawMaterialCode, final String rawMaterialName) {
