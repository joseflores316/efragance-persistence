...
/**
 * The Class FormulaLevelDilution.
 */
public class FormulaLevelDilution {
    ...
    /**
     * Instantiates a new formula level dilution.
     *
     ...
     */
    public FormulaLevelDilution(final Long formulaId, final String formulaCode, final String formulaName,
